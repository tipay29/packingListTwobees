            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mt-2">Carton Create</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form  action="{{route('cartons.store')}}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="ctn_measurement">Measurement</label>
                                <input value="{{old('ctn_measurement')}}" type="text" class="form-control" name="ctn_measurement"
                                       id="ctn_measurement" placeholder="Enter Measurement" required>
                            </div>
                            <div class="form-group">
                                <label for="ctn_weight">Weight</label>
                                <input value="{{old('ctn_weight')}}" type="text" class="form-control" name="ctn_weight"
